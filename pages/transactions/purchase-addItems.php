      ...
      <div class="main-panel">
        ...
        <div class="row">
            ...
            <label> Purchase Order No.</label>
                <input type="text" class="form-control" disabled value="<?php echo  $poID?>">
            </div>  
          </div>
                            ...
                            <div class="table-responsive">
                                <table class="table datatable" id="walkInDataTable">
                                    ...
                                    <?php
                                        ...
                                        $query = $conn->query("select * from `transactions_purchaseorder-items` where `purchaseID` =$poID") or die(mysqli_error());
                                    ...
                                    <td style="padding: 0;"><form style="margin:0;" action="../../php/transactions/purchase/deletePurchaseOrderItem.php" method="post" onsubmit="return confirm('Are you sure you want to delete record?');" >
                                            <input type="hidden" value="<?php echo $maintenanceID?>" name="maintenanceID">       
