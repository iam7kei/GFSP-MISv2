                ...
                <div class="table-responsive">
                    <table class="table datatable" id="walkInDataTable">
                        ...
                        <?php
                                ...
                                $query = $conn->query("select * from `transactions_delivery`") or die(mysqli_error());
                            ...
                            ?>                                      
                                <tr>
                                    ...
                                    <td><?php echo $fetch['deliveryDate']?></td>
                                    <td style="padding: 0;">
                                        <div class="row">
                                            ...
                                            <form style="margin:0;" action="../../php/transactions/delivery/deleteDelivery.php" method="post" onsubmit="return confirm('Are you sure you want to delete <?php echo $fetch['clientName']?>?');" >
                                            <input type="hidden" value="<?php echo $fetch['deliveryID']?>" name="deliveryID">       
